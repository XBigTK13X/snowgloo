    ...
    static {
        ...
        samples.add(
                new MediaItem.Builder()
                        .setUri("http://192.168.1.20:5050/media/trove/media/music/Anime/K-On/Image Songs - Main Cast Part 2 (2013.07)/010 - Diary wa Fortissimo.mp3")
                        .setTitle("Ordinary - BNL")
                        .build());
        samples.add(
                new MediaItem.Builder()
