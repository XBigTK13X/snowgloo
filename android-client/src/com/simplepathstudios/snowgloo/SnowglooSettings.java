...
public class SnowglooSettings {
    public static final String BuildDate = "June 05, 2022";
    public static final String ClientVersion = "1.4.16";
    public static final String DevServerUrl = "http://192.168.1.242:5051";
