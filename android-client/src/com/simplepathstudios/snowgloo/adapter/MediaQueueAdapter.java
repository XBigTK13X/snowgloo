...
import com.simplepathstudios.snowgloo.PlayerManager;
...
public class MediaQueueAdapter {
    private final static String TAG = "MediaQueueAdapter";
    ...
    public MediaQueueAdapter(MainActivity activity, Fragment fragment){
