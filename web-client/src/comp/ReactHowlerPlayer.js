...
class Prepare extends Component {
    ...
    render() {
        const { loadingText = 'Preparing' } = this.props

        let className = 'r-howler light-themed player'

        return (
            <div className={className}>
                <div className={'r-howler light-themed prepare notready'}>{loadingText}</div>
            </div>
        )
    }
}
...
export default class ReactHowlerPlayer extends Component {
    ...
    render() {
        ...
        return (
            <div className="r-howler light-themed player" id="rh-player-main" ref={this.ref}>
                <div hidden>
                ...
                <div className="r-howler light-themed player-controls">
                    <button className="no-focus" type="button" {...btnAttrs} onClick={btnFunction}>
                    ...
                    <div className="volume-control">
                        <button className="no-focus" type="button" onClick={this.toggleMute} id="rh-player-volume" name="volume" aria-label={isMute ? 'Unmute' : 'Mute'}>
                            <svg role="presentation" className="icon">
