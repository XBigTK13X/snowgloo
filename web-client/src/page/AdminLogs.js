...
export default class AdminLogs extends Component{
    ...
    render(){
        ...
        return (
            <div>
            <button className="simple-input" onClick={this.persistLogs}>Persist Logs</button>
            <button className="simple-input" onClick={this.wipeLogs}>Delete Logs</button>
                {err}
                {clientPicker}
                {logs}
            </div>
